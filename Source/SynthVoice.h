...
public:
                          ...
                          int startSample, int numSamples) override
    {
        ...
        // Base cutoffs and resonances — set once per block
        float baseCutoff1 = smoothedCutoff1.getTargetValue();
        float baseCutoff2 = smoothedCutoff2.getTargetValue();
        float res1 = smoothedRes1.getTargetValue();
        float res2 = smoothedRes2.getTargetValue();
        ...
        for (int i = 0; i < numSamples; ++i)
        {
            ...
            // Filter cutoffs with per-sample envelope
            ...
            float cutoff1 = juce::jlimit (80.0f, maxCutoff, baseCutoff1 + envMod1);
            float cutoff2 = juce::jlimit (80.0f, maxCutoff, baseCutoff2 + envMod2);

            // Parallel path — filter1 and filter2 in parallel
            ...
            // Series path — filter1series -> filter2series (separate instances)
